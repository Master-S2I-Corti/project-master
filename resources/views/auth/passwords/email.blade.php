                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <div>
                                ...
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="exemple@univ-corse.fr">
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group{{ $errors->has('email_sos') ? ' has-error' : '' }}">
                            <div>
                                ...
                                <input id="email_sos" type="email" class="form-control" name="email_sos" value="{{ old('email_sos') }}" placeholder="exemple@univ-corse.fr">
