                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-center bg-success">UE1-FONDAMENTAUX-DU-WEB-ET-MOBILE-FA
                                <br>MASTER 1 Informatique Spécialité S2I
                                <br>113</td>
                            <td></td>
                            <td class="bg-success text-center">UE3-CONCEPTION-AGILE-FA
                                ...
                                <br>113</td>
                            <td></td>
                            <td class="text-center bg-info">UE1-FONDAMENTAUX-DU-WEB-ET-MOBILE-FA MASTER 1 Informatique Spécialité S2I 113</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>10h-11h</td>
                            <td class="text-center bg-success">UE1-FONDAMENTAUX-DU-WEB-ET-MOBILE-FA MASTER 1 Informatique Spécialité S2I
                                <br>&nbsp;113</td>
                            <td class="text-center bg-info">UE1-FONDAMENTAUX-DU-WEB-ET-MOBILE-FA
                                <br>LICENCE 3 Informatique Spécialité S2I
                                <br>113</td>
                            <td class="bg-success text-center">UE3-CONCEPTION-AGILE-FA MARIELLE MASTER 1 Informatique Spécialité S2I
                                <br>&nbsp;113</td>
                            <td></td>
                            <td></td>
                            <td></td>
